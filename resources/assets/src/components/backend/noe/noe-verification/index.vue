<template> <div>
  ...
  <b-card header="Verifikasi & Penilaian NOE" header-tag="h4" class="mb-4">
      ...
      <template slot="action" slot-scope="props">
        <div class="custom-actions">
          ...
          <b-btn v-if="props.rowData.IsPublish > 0 && ((props.rowData.Status == 'Dilaporkan ke Unit Head' && position == 1 && truePerson == props.rowData.IdPublish) || (props.rowData.Status == 'Dilaporkan ke Sect Head' && position == 2))" class="btn btn-outline-secondary btn-sm mr-1 mt-1"
            @click="onAction('edit-item', props.rowData, props.rowIndex)">
            <i class="ion ion-md-create"></i> Ubah
          </b-btn>
          <b-btn v-if="props.rowData.IsPublish > 0 && ((props.rowData.Status == 'Dilaporkan ke Unit Head' && position == 1 && truePerson == props.rowData.IdPublish) || (props.rowData.Status == 'Dilaporkan ke Sect Head' && position == 2))" class="btn btn-outline-danger btn-sm mr-1 mt-1"
            @click="onAction('delete-item', props.rowData, props.rowIndex)">
            <i class="ion ion-md-trash"></i> Hapus
          </b-btn>

          <b-btn v-if="props.rowData.IsPublish == 0 && ((position == 1 && props.rowData.Status == 'Dilaporkan ke Unit Head' && truePerson == props.rowData.IdPublish) || (position == 2 && props.rowData.Status == 'Dilaporkan ke Sect Head' && truePerson == props.rowData.IdPublish))" class="btn btn-outline-success btn-sm mr-1 mt-1"
            @click="onAction('edit-item', props.rowData, props.rowIndex)">
            <i class="ion ion-md-checkmark"></i> Verifikasi
          </b-btn>

          <b-btn v-if="props.rowData.IsPublish == 1 && ((props.rowData.Status == 'Dilaporkan ke Unit Head' && position == 1 && truePerson == props.rowData.IdPublish) || (props.rowData.Status == 'Dilaporkan ke Sect Head' && position == 2))" class="btn btn-outline-primary btn-sm mr-1 mt-1"
            @click="onAction('publish-verify', props.rowData, props.rowIndex)">
            <i class="ion-md-cloud-upload"></i> Publish Verifikasi
          </b-btn>

          <!-- <b-btn v-if="props.rowData.IsPublish == 1 && (((position == 3 || isCaretaker == true) && props.rowData.Status == 'Disetujui oleh Sect Head') || (position == 2 && props.rowData.Status == 'Disetujui oleh Unit Head') && truePerson == props.rowData.verifIdPublish )" class="btn btn-outline-primary btn-sm mr-1 mt-1"
            @click="onAction('approve', props.rowData, props.rowIndex)">
            <i class="ion ion-md-checkmark"></i> Setujui
          </b-btn> -->

          <!-- <b-btn v-if="(position == 3 || isCaretaker == true) && props.rowData.Status == 'Disetujui oleh Sect Head' && props.rowData.IsPublish == 1" class="btn btn-outline-danger btn-sm mr-1 mt-1"
            @click="onAction('reject', props.rowData, props.rowIndex)">
            <i class="ion ion-md-close"></i> Tolak
          </b-btn> -->

          <b-btn v-if="(props.rowData.Status == 'Dilaporkan ke Unit Head' && position == 1 && truePerson == props.rowData.IdPublish) || (position == 2 && truePerson == props.rowData.verifIdPublish && (props.rowData.Status == 'Dilaporkan ke Sect Head' || props.rowData.Status == 'Disetujui oleh Unit Head')) || ((position == 3 || isCaretaker == true ) && props.rowData.Status == 'Disetujui oleh Sect Head'  )" class="btn btn-warning btn-sm mr-1 mt-1"
            @click="onAction('correction', props.rowData, props.rowIndex)">
            <i class="fas fa-comment"></i> Koreksi
          </b-btn>

          <div>
            <span v-if="((position == 3 || isCaretaker == true) && props.rowData.Status == 'Disetujui oleh Sect Head') || ((position == 2) && (props.rowData.Status == 'Disetujui oleh Unit Head' || props.rowData.Status == 'Dilaporkan ke Sect Head')) || (props.rowData.Status == 'Dilaporkan ke Unit Head' && position == 1) || (props.rowData.Status == 'Dilaporkan ke Sect Head' && position == 2) " class="btn btn-md btn-warning"></span>
...
export default {
  ...
  methods: {
    ...
    getSession () {
      axios.post('/AdminVue/noe-verification-get-session')
      .then( function (res) {
