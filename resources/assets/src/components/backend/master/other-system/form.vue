      ...
      <form method="POST" @submit.prevent="submitForm()">
        <b-form-row>
          ...
          <b-form-group class="col-md-6">
            ...
            <label class="form-label float-right text-danger">*Wajib Diisi</label>
            <b-input name="Assesment" :state="allErrors.Assesment?false:null" v-model="field.Assesment" class="mb-1" required />
            <span class="text-danger" v-if="allErrors.Assesment">{{ allErrors.Assesment[0] }}</span>
          </b-form-group>
        </b-form-row>
