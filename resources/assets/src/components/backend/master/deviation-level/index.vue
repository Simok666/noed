<template> <div>
  ...
  <b-card header="Level Deviasi" header-tag="h4" class="mb-4">
      ...
      <div class="col-md-4">
          <b-form inline class="">
            ...
            <b-form inline class="">
              <masked-input style="width: 120px;" class="form-control" v-model="paramData.search.dvl__Month" :mask="datemmMask" placeholder="month" v-on:keyup.enter="getFilters()" />
              <masked-input style="width: 120px; margin-left: 2px;" class="form-control" v-model="paramData.search.dvl__Year" :mask="dateYYMask" placeholder="year" v-on:keyup.enter="getFilters()" /> 
            </b-form>
          </b-form>
      </div>
      <div class="col-md-4">
      ...
      <template slot="tableHeader" slot-scope="props">
        <tr class="text-center">
          <th class="wd-50"></th>
          <th>
            <b-input v-model="paramData.search.dvl__Level" placeholder="Level" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
            <b-input v-model="paramData.search.dvl__MaxValue" placeholder="Nilai Maksimal" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
          ...
          <th>
            <masked-input type="text" class="form-control" placeholder="dd.mm.yy"
              v-model="paramData.search.dvl__UpdateAt"
