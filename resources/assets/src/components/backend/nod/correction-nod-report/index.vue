<template> <div>
  ...
  <b-card header="Perbaikan Laporan NOD" header-tag="h4" class="mb-4">
      ...
      <template slot="tableHeader" slot-scope="props">
        <tr class="text-center">
          <th class="wd-50"></th>
          <th>
            <b-input v-model="paramData.search.crt__Number" placeholder="No. NOD" v-on:keyup.enter="getFilters()" />
          </th>
          <th>
