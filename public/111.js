...
var render = function render() {
  ...
  }, [_vm._v("Ada, yaitu ...")])], 1), _vm._v(" "), _vm.selected === true ? _c("b-form-group", _vm._l(_vm.getAnotherEffect, function (item, index) {
    return _c("li", {
      key: index
    }, [_c("b-form-checkbox", {
      attrs: {
  ...
  }, [_vm._v("\n          Setujui")]) : _vm._e(), _vm._v(" "), _vm.isShow == true && (_vm.valStatus == 4 && _vm.field.IdDepartment == _vm.userDepartment && (_vm.Position == 4 || _vm.isCaretaker == true) || _vm.valStatus == 5 && _vm.deptTerkait == true && _vm.statusDeptTerkait == false || _vm.userDepartment == 67 && (_vm.Position == 3 && _vm.valStatus == 6 || _vm.Position == 4 && _vm.valStatus == 6)) ? _c("b-btn", {
    staticClass: "float-right ml-2",
    attrs: {
      type: "button",
      variant: "danger"
