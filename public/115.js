...
var render = function render() {
  ...
  return _c("b-card", {
    ...
    }, [_vm._v(_vm._s(item.UserQA) + " - " + _vm._s(_vm.formatDate(item.DateQA)))]), _vm._v(" "), _c("td", [_vm.isData == true && item.IsRevision == 0 && (_vm.isPublishBy == true || _vm.isSectionPublish == true || _vm.isDept == true || _vm.isRelevantDept == true || _vm.Status == "Disetujui oleh Dept Head Terkait" || _vm.Status == "Disetujui Oleh QA Section Head") ? _c("div", [_c("b-btn", {
      staticClass: "btn btn-outline-success btn-sm mr-1 mt-1",
      on: {
        click: function click($event) {
          return _vm.onAction("approve", _vm.Id, _vm.rowData.id);
        }
      }
    }, [_c("i", {
      staticClass: "ion ion-md-checkmark"
    }), _vm._v(" Setujui\n                            ")]), _vm._v(" "), _vm.isDept ? _c("b-btn", {
